...
/*edit*/define('_AM_VISITSUPPORT', 'This module is eddited by Ladon (Original wfsection by Catzwolf)');
...
//added by ladon
define('_AM_SHOWSPACER', 'Show spacer in below section title?');
define('_AM_SHOWARCHIVES', 'Show archive for eacg section?');
define('_AM_SHOWSPOTLIGHT', 'Show spotlight articles at top?');
define('_AM_SPOTLIGHTARTICLES', 'List spotlight articles?');
define('_AM_SHOWSPOTLIGHTARTICLESTXT', 'All these articles are shown in the spotlight section (at the top of the catagory index).<br><br><b>NOTE:</b> Even when an article has "show in spotlight checked", it still won\'t show when this option has been diabled in the main configuration.');
define('_AM_ISSPOTLIGHT', 'Article in the spotlight section?');
