...
class htmlcleanertag
{
    ...
    public function __construct($str)
    {
        ...
        } elseif (HTML_CLEANER_NODE_NODETYPE_TEXT == $this->nodeType || HTML_CLEANER_NODE_NODETYPE_SPECIAL == $this->nodeType) {
            $this->nodeValue = $str;
        }
    }
    ...
    {
        if (HTML_CLEANER_NODE_NODETYPE_TEXT == $this->nodeType || HTML_CLEANER_NODE_NODETYPE_SPECIAL == $this->nodeType) {
...
class htmlcleaner
{
    ...
    public function cleanup($body)
    {
        ...
        foreach (self::dessicate($body) as $part) {
            ...
            if (false === mb_strstr($part->nodeValue, '<?xml:namespace') && 'span' != $part->nodeName && 'font' != $part->nodeName && 'o' != $part->nodeName && 'script' != $part->nodeName && 'style' != $part->nodeName && 'object' != $part->nodeName && 'iframe' != $part->nodeName && 'applet' != $part->nodeName && 'meta' != $part->nodeName) {
